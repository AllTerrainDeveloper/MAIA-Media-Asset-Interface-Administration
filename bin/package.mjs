 ...
 * with the plugin header, and a `ATME_VERSION` that has drifted silently
...
if ( ! existsSync( join( root, 'assets/css/allterrain-media-explorer.css' ) ) ) {
	fail( 'assets/css/allterrain-media-explorer.css is missing.' );
}
